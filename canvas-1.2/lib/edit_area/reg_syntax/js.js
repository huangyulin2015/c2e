editAreaLoader.load_syntax["js"] = {
	...
	,'STYLES' : {
		'COMMENTS': 'color: #880066;'
		,'QUOTESMARKS': 'color: #00ee11;'
		,'KEYWORDS' : {
			'statements' : 'color: #FF3333; font-weight: bold;'
			,'keywords' : 'color: #0011ee;'
			,'functions' : 'color: #3322ff; font-weight: bold;'
		}
		,'OPERATORS' : 'color: #FFFFFF;'
		,'DELIMITERS' : 'color: #CCCCCC;'
